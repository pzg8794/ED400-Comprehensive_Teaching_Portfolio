...
\title{Comprehensive Teaching Portfolio\\\large Childhood Education / Elementary Working Draft}
\author{Piter Garcia}
\date{EDU 400A Rough Draft - May 2026}

\begin{document}
\maketitle

\section*{Rubric and public repository}
...
Working certification-area rubric: Childhood Education / Elementary. This is the best match for the current evidence base because the portfolio evidence centers Grade 4 TeachingPlacement, Pine Brook Elementary, Minecraft Education, elementary computer science instruction, ED452B unit planning, ED400A reflection, and EDU442 identity/equity work.
...
The full portfolio includes a personal statement and ten proficiency narratives. This report contains a drafted personal statement and a rubric-aligned rough draft for Proficiency 2. The Proficiency 2 paper is the current EDU 400A rough-draft submission focus.

\section{Artifact reference hub}

\begin{longtable}{p{0.14\textwidth}p{0.28\textwidth}p{0.26\textwidth}p{0.22\textwidth}}
\textbf{ID} & \textbf{Artifact} & \textbf{Portfolio use} & \textbf{Public link}\\ \hline
P00 & Full portfolio report & Overall portfolio / Overleaf output & \href{../reports/portfolio.pdf}{reports/portfolio.pdf}\\
P02 & Proficiency 2 rough draft PDF & EDU 400A rough draft & \href{../drafts/proficiency-02-learner-diversity-equity.md}{Markdown draft}\\
A01 & Dear Future-Teacher Me public copy & Personal Statement; Proficiency 2, 9, 10 & \href{../artifacts/public-copies/dear-future-teacher-me.md}{public copy}\\
A02 & Grade 4 IGNITE Minecraft evidence summary & Proficiency 2, 3, 5, 6, 7, 8 & \href{../artifacts/public-copies/minecraft-grade4-ignite-evidence-summary.md}{public copy}\\
A03 & Trauma-informed reflection summary & Personal Statement; Proficiency 2, 3, 9, 10 & \href{../artifacts/public-copies/trauma-informed-reflection-summary.md}{public copy}\\
A04 & Childhood Education rubric summary & Rubric alignment & \href{../rubrics/childhood-education-rubric-summary.md}{rubric summary}\\
\end{longtable}

Because this is a public repository, private ED400A and TeachingPlacement originals are treated as provenance. Public-safe copies and summaries are used for submission.

\section{Personal Statement - Draft}
